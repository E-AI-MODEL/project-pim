...
export function ResultActions({ verdict, liveVerdict, onPrimary, onCopy, onDownload, safeText, busy }: Props) {
  const map = {
  ...
  return (
    <div className="space-y-1.5">
      ...
      {shortMsg && (
        <div className="text-[11px] text-rose-300 px-1">{shortMsg}</div>
      )}
    </div>
  );
}