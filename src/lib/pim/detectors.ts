...
const RULES: RuleDef[] = [
  ...
  { id: "rule.name_intro", category: "name", regex: /(?<=\b(?:ik heet|mijn naam is|noem (?:mij|me)|ik ben)\s+)[A-Z][a-zà-ÿ]+(?:\s+(?:van|de|der|den|ter|ten)\s+[A-Z][a-zà-ÿ]+|\s+[A-Z][a-zà-ÿ]+)?/g, confidence: 0.8 },
