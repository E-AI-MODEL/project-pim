...
export const PIPELINE_PROFILES: Record<PipelineProfileId, PipelineProfile> = {
  "education-nl-full": {
    ...
    detectors: { rules: true, specialLexicon: true, nerSlm: true, contextSlm: true, rewriteLlm: false },
    egressPolicy: "full",
  ...
  "education-nl-rules-only": {
    ...
    detectors: { rules: true, specialLexicon: true, nerSlm: false, contextSlm: false, rewriteLlm: false },
  ...
  "healthcare-nl": {
    ...
    detectors: { rules: true, specialLexicon: true, nerSlm: true, contextSlm: false, rewriteLlm: false },
  ...
  "generic-nl": {
    ...
    label: "Generic NL",
    description: "Ontwerpvoorbereiding. Niet vrijgegeven in release 1.",
    detectors: { rules: true, specialLexicon: false, nerSlm: true, contextSlm: false, rewriteLlm: false },
    egressPolicy: "design_only",
    releaseStatus: "design-only",
  },
  "generic-en": {
